...
namespace CastFlow.Migrations
{
    ...
    [Migration("20250519115001_AddVideoInstructionsToRoleAndVideoUrlToCandidature")]
    partial class AddVideoInstructionsToRoleAndVideoUrlToCandidature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CastFlow.Api.Models.Candidature", b =>
                {
                    ...
                    b.Property<DateTime?>("DispoDebut")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CastFlow.Api.Models.Notification", b =>
                {
                    ...
                    b.Property<long>("DestinataireTalentId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("LienNavigationFront")
                        .HasMaxLength(255)
                    ...
                    b.Property<string>("TypeEntiteLiee")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.HasKey("NotificationId");

                    b.HasIndex("DestinataireTalentId");
            ...
            modelBuilder.Entity("CastFlow.Api.Models.Notification", b =>
                {
                    b.HasOne("CastFlow.Api.Models.UserTalent", "DestinataireTalent")
                        .WithMany()
                        .HasForeignKey("DestinataireTalentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DestinataireTalent");
                });
